...
graph =  Graph("http://localhost:7474",username="neo4j",password="uzei")
graph.run("MATCH (n) DETACH DELETE n") # 清空数据库

# 限制条件
prior_conditions = json.load(open("/home/uzei/myrobot/src/ros_openvino/config/my_ontology.json", "r"))
