...
#include "object_detect_yolo.hpp"
...
int main(int argc, char *argv[]) {
    try {
        ...
        InferencePlugin OpenVino_plugin = PluginDispatcher({"../../../lib/intel64", ""}).getPluginByDevice("MYRIAD");
        ...
        network_reader.ReadNetwork("/home/ghowoght/workplace/myrobot/src/ros_openvino/models/Yolov3/FP16/frozen_yolo_v3.xml");
        network_reader.ReadWeights("/home/ghowoght/workplace/myrobot/src/ros_openvino/models/Yolov3/FP16/frozen_yolo_v3.bin");
        /** Reading labels (if specified) **/
        std::vector<std::string> labels;
        std::ifstream inputFile("/home/ghowoght/workplace/myrobot/src/ros_openvino/models/Yolov3/FP16/frozen_yolo_v3.labels");
        std::string label; 
        ...
        ICNNNetwork::InputShapes inputShapes = network_reader.getNetwork().getInputShapes();
        SizeVector& inSizeVector = inputShapes.begin()->second;
        inSizeVector[0] = 1;  // set batch to 1
        network_reader.getNetwork().reshape(inputShapes);
        // --------------------------------- Preparing output blobs -------------------------------------------
        slog::info << "Checking that the outputs are as the demo expects" << slog::endl;
        OutputsDataMap outputInfo(network_reader.getNetwork().getOutputsInfo());
        ...
        if (auto ngraphFunction = network_reader.getNetwork().getFunction()) {
